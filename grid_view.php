...
<div class="row">
    ...
    <tr>
   <td>UG CGPA:</td>
   <td><input name="ug_cgpa" class="in" type="text" onclick="view()" placeholder="College Name" required></input class="in"></td>
  </tr>
...
<script>
    ...
    include('admin.php');
      ...
      <table align="center" id="myTable">
        <tr>
          <td><img align="center" src="./image/<?php echo $rows['Photo']; ?>"></td></tr>
          <tr><td><?php echo "FirstName  : ",$rows['FirstName'];?></td></tr>
          <tr><td><?php echo "MiddleName : ",$rows['MiddleName'];?></td></tr>
          <tr><td><?php echo "LastName   :",$rows['LastName'];?></td></tr>
          </tr>
        <?php
      }
      mysqli_close($conn);
